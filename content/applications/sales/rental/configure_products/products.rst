...
.. example::
   **Part 2**
   ...
   :menuselection:`Rental app --> Products --> Products` and click the bike product. Click the
...
Click into the :guilabel:`Tracking` field and select either :guilabel:`By Unique Serial Number`.
