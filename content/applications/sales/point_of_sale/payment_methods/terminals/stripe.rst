...
For point-of-sale setups, Stripe can be used with a choice of `proprietary and terminals
 <https://stripe.com/terminal/devices>`_. Additionally, it integrates with Tap to Pay to accept
contactless payments directly on compatible Android and iOS devices.
...
- :ref:`An Odoo payment method configured and linked to the physical device. <pos/stripe/method>`
- :ref:`A Stripe account connected to your Odoo database using API keys. <pos/stripe/stripe_config>`
